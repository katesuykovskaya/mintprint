...
//            array('email','required','on'=>'insert'),
	...
	public function search()
	{
		...
		//$criteria->compare('u_group_id',$this->u_group_id);
		//$criteria->compare('role',$this->role,true);
		$criteria->compare('login',$this->login,true);
		$criteria->compare('pass',$this->pass,true);
		//$criteria->compare('salt',$this->salt,true);
		//$criteria->compare('enrol_date',$this->enrol_date,true);
		//$criteria->compare('last_active_counter',$this->last_active_counter,true);
		//$criteria->compare('user_counter',$this->user_counter);
		//$criteria->compare('active',$this->active,true);
		//$criteria->compare('login_multi_use',$this->login_multi_use,true);
        ...
        {  
        $arr = Users::model()->findAll();
        $users = CHtml::listData($arr,'user_id','login');
           
        return CHtml::dropDownList('users','',$users);
        }
      ...
      /*рекурсивный проход по массиву с целью создания одномерного*/
        ...
        public function getOnline(){
            return ((strtotime($this->last_action_time) + 600 ) > time()) ? 'online' : 'offline';
        }
