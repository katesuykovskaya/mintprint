...
class RGenerator extends CApplicationComponent
{
	...
	*/
    ...
    /*EDITED + backend configuration*/

	protected function getAllControllers()
	{
		$basePath = Yii::app()->basePath;
		$items['controllers'] = $this->getControllersInPath($basePath.DIRECTORY_SEPARATOR.'backend/controllers');
	...
	*/
	...
	protected function getControllersInModules($path)
	{
		...
		$modulePath = $path.DIRECTORY_SEPARATOR.'backend/modules';
