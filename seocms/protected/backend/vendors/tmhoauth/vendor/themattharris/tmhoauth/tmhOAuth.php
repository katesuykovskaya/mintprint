...
class tmhOAuth {
  ...
  private function set_user_agent() {
     ...
     *
     * @param int|string $length how many characters the nonce should be before MD5 hashing. default 12
     * @param bool|string $include_time whether to include time at the beginning of the nonce. default true
     * @return string $nonce as a string
     */
  ...
  private function timestamp() {
     ...
     * @return array|mixed|string $data encoded in a way compatible with OAuth
     */
  ...
  private function multipart_escape($value) {
     ...
     *
     * @internal param array $params the parameters for the request
  ...
  public function bearer_token_credentials() {
     ...
     * @param bool|string $useauth whether to use authentication when making the request. Default true
     * @param bool|string $multipart whether this request contains multipart data. Default false
