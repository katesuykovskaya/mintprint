...
function drawChart() {
    ...
    chartBtn = document.getElementById('chart-gallery-btn');
    ...
    var chart = new google.visualization.Gauge(document.getElementById('chart-gallery-div'));
    chart.draw(data, options);
}/**
 * Created by chosen1 on 13.11.13.
 */
$(document).on("click",'#chart-gallery-btn',function(e){
    e.preventDefault();
    $.ajax({
        type:"POST",
        url:$(this).attr("href"),
