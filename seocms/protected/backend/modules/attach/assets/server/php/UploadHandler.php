...
//                    ),
     ...
     * REMEMBER!!! this damn lib uses file main.js with hardcoded script_url wich is ajax-called!!!
     */
...
//        if (!empty($version)) {
    ...
    public function post($print_response = true) {
        ...
        /* if the model isNewRecord we need to get its id first! (then to save attaches to this id)*/
//        if(!$this->options['model'] || $this->options['model']->isNewRecord){
//
...
//                        $upload['type'][$index],
//                        $upload['error'] = 'Save the model first',
//                        $index,
//                        $content_range
//                    );
//                }
