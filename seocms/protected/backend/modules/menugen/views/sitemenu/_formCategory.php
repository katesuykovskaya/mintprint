...
?>
<h6>
    <?php echo Yii::t('backend','Поля отмеченные <span class="required">*</span> обязательны к заполнению')?>
</h6><br />
...
<?php echo $form->errorSummary($model);
    ...
    echo $form->hiddenField($model,'link_type',array('value'=>'category'));
    echo $form->error($model,'link_type');

    echo $form->labelEx($model,Yii::t('backend','Родитель'));
