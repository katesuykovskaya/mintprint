...
<h3 class="page-header"><?php echo Yii::t('backend','Редактирование меню')." \"".$model->translation[Yii::app()->language]['t_text']."\"";?></h3>
...
<div class="row-fluid">
    ...
    <div class="row-fluid">
        <div id="ajaxMenuGrid">
            <?=Sitemenu::drawAjaxGrid2(Yii::app()->language,$type);?>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).on("click",".icon-trash",function(){
        ...
        if(confirm("<?=Yii::t('backend','Это действие удалит текущий пункт меню и все его дочерние пункты!')?>")){
            var curRow = $(this).closest("tr");
