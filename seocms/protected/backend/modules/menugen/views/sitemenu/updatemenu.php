<div class="row">
    <ul class="breadcrumb span6">
        ...
        <li><span class="divider">/</span><?=CHtml::link($parent->translation[Yii::app()->language]->t_text,$this->createUrl('backend/menugen/sitemenu/view',['type'=>$model->type,'language'=>Yii::app()->language]))?></li>
