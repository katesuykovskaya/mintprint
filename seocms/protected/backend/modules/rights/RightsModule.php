...
//        '<language:(\w){2}>/rights'=>'rights/assignment',
//            'backend/rights/<controller:\w+>/<action:\w+>'=>'rights/<controller>/<action>',
//        '<language:(\w){2}>/rights/<controller:\w+>/<action:\w+>'=>'rights/<controller>/<action>',
        );
	/**
	...
	*/
	public function init()
	{
		...
		$this->setImport(array(
			...
			'backend.modules.rights.components.behaviors.*',
			'backend.modules.rights.components.dataproviders.*',
			'backend.modules.rights.controllers.*',
	...
	*/
	public function getAssetsUrl()
	{
		...
		{
			$assetsPath = Yii::getPathOfAlias('backend.modules.rights.assets');
