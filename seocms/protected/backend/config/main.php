...
//                '/backend/mainmenu-create'=>'menugen/sitemenu/mainmenu',
                ...
                '<language:[a-zA-Z]{2}>/backend/multilanguage/<controller:\w+>/<action:\w+>'=>'multilanguage/<controller>/<action>',
                'backend/multilanguage/<controller:\w+>/<action:\w+>'=>'multilanguage/<controller>/<action>',
